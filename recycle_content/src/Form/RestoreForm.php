...
/**
 * @file
 * Contains \Drupal\recycle_content\Form\PurgeForm.
 */
...
class RestoreForm extends ConfirmFormBase {
  ...
  public function getCancelUrl() {
    return new Url('recycle_content.entity_list', ['entity_type_id' => $this->entity->getEntityTypeId()]);
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    if ($entity->save()) {
      ...
      $form_state->setRedirect('recycle_content.entity_list', ['entity_type_id' => $this->entity->getEntityTypeId()]);
    }
  }
